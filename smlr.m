...
args = propval(varargin, defaults, 'strict', true);
...
if args.mex
  ...
  if args.verbose
    fprintf('Completed (%d iterations, %g seconds)\n', iter, ...
...
if args.verbose
  fprintf('SMLR: Using Matlab Native SMLR routine\n');
end
...
if args.verbose
  fprintf('SMLR: Using random seed=%d\n',args.seed);
end
